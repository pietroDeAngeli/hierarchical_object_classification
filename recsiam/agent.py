...
class Agent(object):
    ...
    def process_next(self, data, s_id):
        ...
        embed = self.forward(data).cpu().numpy() # Identity function for now, but can be used to extract features for the memory
        # TODO: change it to gpu if the memory is on gpu or your're computing embeddings runtime
